...
public:
    GraphicsAPI_Vulkan();
    GraphicsAPI_Vulkan(XrInstance mXrInstance, XrSystemId systemId);
    ~GraphicsAPI_Vulkan();
...
private:
    void LoadPFN_XrFunctions(XrInstance mXrInstance);
    std::vector<std::string> GetInstanceExtensionsForOpenXR(XrInstance mXrInstance, XrSystemId systemId);
    std::vector<std::string> GetDeviceExtensionsForOpenXR(XrInstance mXrInstance, XrSystemId systemId);

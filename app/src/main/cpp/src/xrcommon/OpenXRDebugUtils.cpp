...
XrDebugUtilsMessengerEXT CreateOpenXRDebugUtilsMessenger(XrInstance mXrInstance) {
    ...
    OPENXR_CHECK(xrGetInstanceProcAddr(mXrInstance, "xrCreateDebugUtilsMessengerEXT", (PFN_xrVoidFunction *)&xrCreateDebugUtilsMessengerEXT), "Failed to get InstanceProcAddr.");

    // Finally create and return the XrDebugUtilsMessengerEXT.
    OPENXR_CHECK(xrCreateDebugUtilsMessengerEXT(mXrInstance, &debugUtilsMessengerCI, &debugUtilsMessenger), "Failed to create DebugUtilsMessenger.");
...
void DestroyOpenXRDebugUtilsMessenger(XrInstance mXrInstance, XrDebugUtilsMessengerEXT debugUtilsMessenger) {
    ...
    OPENXR_CHECK(xrGetInstanceProcAddr(mXrInstance, "xrDestroyDebugUtilsMessengerEXT", (PFN_xrVoidFunction *)&xrDestroyDebugUtilsMessengerEXT), "Failed to get InstanceProcAddr.");
